...
var ae2 = defineComponent({
  ...
  setup(t2) {
    ...
    return onServerPrefetch(async () => {
      try {
        const { default: r2 } = await import("./apexcharts.ssr.esm-fe46cd2d-HXLZN4YR.js"), n2 = Object.assign({}, t2.options, {
...
var P2 = defineComponent({
  ...
  setup(t2) {
    ...
    onMounted(async () => {
      try {
        const { default: r2 } = await import("./apexcharts.ssr.esm-fe46cd2d-HXLZN4YR.js");
